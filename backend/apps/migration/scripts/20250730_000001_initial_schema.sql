...
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "attachments" ADD CONSTRAINT "attachments_salon_id_salons_id_fk" FOREIGN KEY ("salon_id") REFERENCES "public"."salons"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "download_logs" ADD CONSTRAINT "download_logs_attachment_id_attachments_id_fk" FOREIGN KEY ("attachment_id") REFERENCES "public"."attachments"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "download_logs" ADD CONSTRAINT "download_logs_share_link_id_share_links_id_fk" FOREIGN KEY ("share_link_id") REFERENCES "public"."share_links"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "download_logs" ADD CONSTRAINT "download_logs_downloaded_by_users_id_fk" FOREIGN KEY ("downloaded_by") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "share_links" ADD CONSTRAINT "share_links_attachment_id_attachments_id_fk" FOREIGN KEY ("attachment_id") REFERENCES "public"."attachments"("id") ON DELETE cascade ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
  ALTER TABLE "share_links" ADD CONSTRAINT "share_links_created_by_users_id_fk" FOREIGN KEY ("created_by") REFERENCES "public"."users"("id") ON DELETE restrict ON UPDATE no action;
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
DO $$ BEGIN
...
EXCEPTION
  WHEN duplicate_object THEN null;
END $$;--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_attachments_salon_id" ON "attachments" USING btree ("salon_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_attachments_uploaded_by" ON "attachments" USING btree ("uploaded_by" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_bookings_customer_id" ON "bookings" USING btree ("customer_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_bookings_salon_id" ON "bookings" USING btree ("salon_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_download_logs_attachment_id" ON "download_logs" USING btree ("attachment_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reservations_customer_id" ON "reservations" USING btree ("customer_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reservations_salon_id" ON "reservations" USING btree ("salon_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reservations_staff_id" ON "reservations" USING btree ("staff_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reservations_start_time" ON "reservations" USING btree ("start_time" timestamptz_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reviews_customer_id" ON "reviews" USING btree ("customer_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reviews_rating" ON "reviews" USING btree ("rating" int4_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_reviews_salon_id" ON "reviews" USING btree ("salon_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_services_salon_id" ON "services" USING btree ("salon_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sessions_expires_at" ON "sessions" USING btree ("expires_at" timestamptz_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sessions_refresh_token" ON "sessions" USING btree ("refresh_token" text_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sessions_user_id" ON "sessions" USING btree ("user_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_share_links_attachment_id" ON "share_links" USING btree ("attachment_id" uuid_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_share_links_token" ON "share_links" USING btree ("token" text_ops);--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_staff_salon_id" ON "staff" USING btree ("salon_id" uuid_ops);--> statement-breakpoint
