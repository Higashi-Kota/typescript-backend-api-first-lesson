...
-- File upload related enum and tables
...
-- Add foreign key constraints for file upload tables
...
CREATE INDEX idx_attachments_salon_id ON attachments(salon_id);
CREATE INDEX idx_share_links_attachment_id ON share_links(attachment_id);
CREATE INDEX idx_share_links_token ON share_links(token);
CREATE INDEX idx_download_logs_attachment_id ON download_logs(attachment_id);