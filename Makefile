...
ci-check:
	...
	@echo "======================================"
	@echo ""
	@echo "Step 0/15: Cleaning all dependencies for fresh start..."
	@pnpm clean:all
	@echo "✅ Clean completed"
	@echo ""
	@echo "Step 1/15: Verifying lockfile integrity..."
	...
	@echo ""
	@echo "Step 2/15: API specification generation..."
	-@$(MAKE) generate-spec 2>/dev/null || echo "⚠️  TypeSpec has warnings but continuing..."
	@echo ""
	@echo "Step 3/15: API client generation..."
	-@$(MAKE) generate-client 2>/dev/null || echo "⚠️  Client generation has warnings but continuing..."
	@echo ""
	@echo "Step 4/15: Backend types generation..."
	-@$(MAKE) generate-backend 2>/dev/null || echo "⚠️  Backend types generation has warnings but continuing..."
	@echo ""
	@echo "Step 5/15: Building config package (required for database scripts)..."
	@pnpm --filter @beauty-salon-backend/config build:prod || (echo "❌ Config package build failed." && exit 1)
	@echo "✅ Config package built"
	@echo ""
	@echo "Step 6/15: Database schema generation and seeding..."
	...
	@echo ""
	@echo "Step 13/15: Running backend tests..."
	@$(MAKE) test-backend-ci || (echo "❌ Backend tests failed." && exit 1)
	@echo "✅ Backend tests passed"
	@echo ""
	@echo "Step 14/15: Running frontend tests..."
